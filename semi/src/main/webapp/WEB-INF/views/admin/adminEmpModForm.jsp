...
<body>
 <div class="wrapper">
	...
	<table>
	   <tr class="tblRow">
	      <td><label for="number">요양사번호</label></td>
	   ...
	   <tr>
	    ...
	    <tr>
	       ...
	       <td><input type="text" class="date" id="birth" name="birth"></td>
	    </tr>
	    <tr>
	    ...
	    <tr>
	       <td><label for="room_number">담당병실</label></td>
	       <td><input type="text" id="room_number" name="room_number"></td>
	    </tr>
	    <tr>
	       <td><label for="start_date ">근무시작일</label></td>
	       <td><input type="text" class="date" id="start_date" name="start_date "></td>
	    </tr>
	    <tr>
	       <td><label for="resignation_date">퇴사일</label></td>
	       <td><input type="text" class="date" id="resignation_date" name="resignation_date  "></td>
	    </tr>
	    <tr>
